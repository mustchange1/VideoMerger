...
def main() -> int:
    ...
    parser.add_argument("--quote", action="store_true", help="enable the quote card")
    parser.add_argument("--quote-text", default="", help="generated quote card text")
    parser.add_argument("--quote-attribution", default="", help="generated quote card attribution")
    parser.add_argument(
        "--quote-artwork", default="",
        help="uploaded Quote artwork (.png, .jpg, .jpeg, .webp or .pdf); selects artwork mode",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="artwork composition mode; Fit preserves the complete artwork (default)",
    )
    ...
    settings = ExportSettings(
        ...
        quote_input_mode="artwork" if args.quote_artwork else "text",
